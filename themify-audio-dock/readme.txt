...
1. Download the plugin as a zip file (do not extract the zip file). Go to WP-admin > Plugins > Add New > Upload Plugin, upload the plugin zip to install & activate it.
2. Go to Settings > Themify Audio Dock from the admin menu.
3. Add audio tracks you want. Enjoy!
